...
class AppError extends Error {
    constructor(message, statusCode=500, code='INTERNAL ERROR') {
            super(message) 
...
class AuthorizationError extends AppError {
    constructor(message = 'Access denied') {
        super(message, 402, 'AUTHORIZATION_ERROR')
    }
}
...
class DatabaseError extends AppError {
    constructor(message = 'Database operation failed') {
        super(message, 401, 'DATABASE_ERROR')
    }
}
...
class ErrorUtils {
    ...
    static logError(error, logger, context={}) {
        const logData = {
            ...
            code: error.statusCode || this.getStatusCode(error),
            statusCode: error.statusCode,
            stack: error.stack,
            ...context
        }
        
        if(this.isOperational && error.statusCode < 500) {
